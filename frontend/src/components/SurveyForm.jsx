...
const SurveyForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const serviceLabel = formData.service === '4.5 inch'
            ? (language === 'en' ? '4.5 Inch (Residential)' : '4.5 \u0C05\u0C02\u0C17\u0C41\u0C33\u0C3E\u0C32\u0C41 (\u0C07\u0C02\u0C1F\u0C3F\u0C15\u0C3F)')
        ...
        const whatsappUrl = 'https://wa.me/919100111643?text=' + encodeURIComponent(message);
            ...
            {submitted ? (
                ...
                <form onSubmit={handleSubmit} className={s.form} noValidate>
                    ...
                    <button type="submit" className={s.submitBtn} disabled={isSubmitting}>
                        ...
                        {isSubmitting
                            ? (language === 'en' ? 'Opening WhatsApp...' : '\u0C24\u0C46\u0C30\u0C41\u0C1A\u0C41\u0C15\u0C41\u0C02\u0C1F\u0C41\u0C28\u0C4D\u0C28\u0C3E\u0C2E\u0C41...')
                            : (language === 'en' ? 'Send via WhatsApp' : 'WhatsApp \u0C32\u0C4B \u0C2A\u0C02\u0C2A\u0C02\u0C21\u0C3F')}
                    </button>
                </form>
            )}
        </div>
