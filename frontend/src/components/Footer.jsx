        ...
        <footer className={s.footer}>
            <div className={s.grid}>
                ...
                <div>
                    <div className={s.brand}>
                        <img src="images/logo.png" alt="JMJ Borewells Logo" className={s.brandLogo} />
                ...
                <div>
                    ...
                    {(language === 'en'
                        ? ['4.5" Domestic Borewell', '6.5" High Yield Borewell', 'Borewell Pressing/Flushing', 'Scientific Sensor Survey']
                        : ['4.5" ఇంటి బోర్‌వెల్', '6.5" హై యీల్డ్ బోర్‌వెల్', 'బోర్‌వెల్ ప్రెస్సింగ్', 'సైంటిఫిక్ సర్వే']
                    ).map((svc, i) => (
                ...
                <div>
                    ...
                    <div className={s.contactItem}>
                        ...
                        <a href="mailto:jmjborewell@gmail.com" className={s.contactLink}>jmjborewell@gmail.com</a>
                    </div>
                    <div className={s.contactItem}>
            ...
            <div className={s.bottomBar}>
                <div className={s.copyright}>
                    © {currentYear} JMJ Borewells. {language === 'en' ? 'All Rights Reserved.' : 'అన్ని హక్కులు రిజర్వ్ చేయబడ్డాయి.'}
                </div>
                ...
                <div className={s.modalOverlay} onClick={() => setShowPrivacy(false)}>
                    <div className={s.modal} onClick={(e) => e.stopPropagation()}>
                        <div className={s.modalHeader}>
                            ...
                            <button className={s.modalClose} onClick={() => setShowPrivacy(false)} aria-label="Close">
                                <X size={20} />
                            </button>
                        </div>
                        <div className={s.modalBody}>
                            {language === 'en' ? (
                                <>
                                    ...
                                    <p>When you submit a site survey request, we collect your name, phone number, village/landmark, and service preference. This information is used solely to contact you regarding your borewell service inquiry.</p>
                                    <h4>How We Use Your Information</h4>
                                    <p>Your personal information is used exclusively to respond to your service inquiry, provide quotes, and schedule site surveys. We do not sell, rent, or share your information with third parties.</p>
                                    <h4>Data Security</h4>
                                ...
                                <>
                                    <p><strong>చివరి అప్‌డేట్:</strong> మార్చి 2026</p>
                                    <h4>మేము సేకరించే సమాచారం</h4>
                                    <p>మీరు సైట్ సర్వే రిక్వెస్ట్ సమర్పించినప్పుడు, మీ పేరు, ఫోన్ నెంబర్, గ్రామం/ల్యాండ్‌మార్క్ మరియు సర్వీస్ ప్రాధాన్యతను సేకరిస్తాము.</p>
                                    <h4>మీ సమాచారాన్ని ఎలా ఉపయోగిస్తాము</h4>
                                    <p>మీ వ్యక్తిగత సమాచారం మీ సేవా విచారణకు ప్రతిస్పందించడానికి, కోట్‌లు అందించడానికి మరియు సైట్ సర్వేలను షెడ్యూల్ చేయడానికి మాత్రమే ఉపయోగించబడుతుంది.</p>
                                    <h4>డేటా భద్రత</h4>
